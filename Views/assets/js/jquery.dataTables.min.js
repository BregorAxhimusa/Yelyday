...
(function (k) {
	...
	function fa(a) {
		...
		if (-1 !== k.inArray(!1, b)) U(a, !1);
			...
			g !== q &&
				-1 !== g &&
				((a._iDisplayStart = h ? g : g >= a.fnRecordsDisplay() ? 0 : g), (a.iInitDisplayStart = -1));
			g = a._iDisplayStart;
	...
	function Jb(a) {
		...
		var l = function () {
			...
			m != e.sSearch &&
				(ya(a, { sSearch: m, bRegex: e.bRegex, bSmart: e.bSmart, bCaseInsensitive: e.bCaseInsensitive }),
				(a._iDisplayStart = 0),
				fa(a));
		};
		...
		b = function (h) {
			if (h && h.time) {
				...
				if (
					-1 === k.inArray(!1, l) &&
					((l = a.iStateDuration),
					!((0 < l && h.time < +new Date() - 1e3 * l) || (h.columns && f.length !== h.columns.length)))
				) {
	...
	function aa(a, b, c, d) {
		...
		else if (((b = u.ext), (b = b.sErrMode || b.errMode), a && H(a, null, 'error', [a, d, c]), 'alert' == b))
			alert(c);
		else {
			...
			for (f = h.length; m < f; m++) {
				...
				if ('table' === b) {
					...
					for (g = v.length; x < g; x++)
						(t = v[x]),
							(t = 'cell' === b ? c.call(p, h[m], t.row, t.column, m, x) : c.call(p, h[m], t, m, x, l)),
							t !== q && e.push(t);
				}
			}
			return e.length || d
	...
	D.register = w = function (a, b) {
		if (Array.isArray(a)) for (var c = 0, d = a.length; c < d; c++) D.register(a[c], b);
			...
			for (c = d.length; a < c; a++) {
				...
				a === c - 1
					? ((h.val = b),
					  (h.type = 'function' === typeof b ? 'function' : k.isPlainObject(b) ? 'object' : 'other'))
		...
		wc = function (a, b, c) {
			...
			return tb(
				...
				function (e) {
					...
					if ('string' === typeof e && '#' === e.charAt(0) && ((f = a.aIds[e.replace(/^#/, '')]), f !== q))
						return [f.idx];
	...
	var xc = function (a, b, c, d) {
		...
		pc = function (a, b) {
			...
			c.length &&
				a.length &&
				((a = c[0].aoData[a[0]]),
				a._details && ((a._detailsShow = b) ? a._details.insertAfter(a.nTr) : a._details.detach(), yc(c[0])));
		},
		yc = function (a) {
			var b = new D(a),
				c = a.aoData;
				...
				k(a.nTable).on('order.dt.DT', function (e, f, g, h) {
					a === f &&
						...
						b
							...
							.addClass('asc' == h[e] ? d.sSortAsc : 'desc' == h[e] ? d.sSortDesc : c.sSortingClass));
				});
			},
