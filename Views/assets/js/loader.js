(function() {
   ...
   */
    ...
    function Pb(a, b) {
        if (0 == a.a)
            if (a.c) {
                ...
                if (c.b) {
                    for (
                        var d = 0, e = null, f = null, g = c.b; g && (g.h || (d++, g.a == a && (e = g), !(e && 1 < d))); g = g.next
                    )
                        e || (f = g);
                    e &&
                        (0 == c.a && 1 == d ?
                            Pb(c, b) :
                            (f ? ((d = f), d.next == c.g && (c.g = d), (d.next = d.next.next)) : Qb(c),
                                Rb(c, e, 3, b)));
                }
                a.c = null;
            } else O(a, 3, b);
    ...
    N.prototype.m = function() {
        for (var a;
            (a = Qb(this));) Rb(this, a, this.a, this.j);
        this.i = !1;
    };
        ...
        return J.f.o.load(b, { version: c.ba }).then(function() {
            ...
            Nc = function(e) {
                ...
                if (null == e || null == e.then) {
                    var f =
                        y('google.charts.loader.publicSetOnLoadCallback') ||
                        y('google.charts.versionSpecific.setOnLoadCallback');
