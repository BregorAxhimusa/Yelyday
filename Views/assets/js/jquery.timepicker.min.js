!(function(e) {
    ...
    !(function() {
        ...
        (e.TimePicker.prototype = {
            ...
            _items: function(t, i) {
                var r,
                    ...
                    s = e('<ul></ul>'),
                    c = null;
                for (-1 === t.options.timeFormat.indexOf('m') &&
                    t.options.interval % 60 !== 0 &&
                    (t.options.interval = 60 * Math.max(Math.round(t.options.interval / 60), 1)),
                    r = i ?
                    n(i) :
                    t.options.startTime ?
                    n(t.options.startTime) :
                    n(t.options.startHour, t.options.startMinutes),
                    a = new Date(r.getTime() + 864e5); a > r;
            ...
            _isValidTime: function(e, t) {
                ...
                return (
                    ...
                    null !== i && null !== r ? t >= i && r >= t : null !== i ? t >= i : null !== r ? r >= t : !0
                );
            },
            _hasScroll: function() {
            ...
            register: function(t, i) {
                ...
                r.element.data('TimePicker') ||
                    ((r.options = e.metadata ? e.extend({}, i, r.element.metadata()) : e.extend({}, i)),
                        (r.widget = n),
                        e.extend(r, {
                            next: function() {
                                return n.next(r);
            ...
            _setDefaultTime: function(t) {
                'now' === t.options.defaultTime ?
                    ...
                    t.options.defaultTime && t.setTime(e.fn.timepicker.parseTime(t.options.defaultTime));
            },
            ...
            deactivate: function() {
                var e = this;
                e.active &&
                    (e.active.children('a').removeClass('ui-state-hover').removeAttr('id'), (e.active = null));
            },
            next: function(e) {
                return (
                    (this.closed() || this.instance === e) && this._move(e, 'next', '.ui-menu-item:first'),
                    e.element
                );
            },
            previous: function(e) {
                return (
                    (this.closed() || this.instance === e) && this._move(e, 'prev', '.ui-menu-item:last'), e.element
                );
            },
            first: function(e) {
            ...
            open: function(t) {
                ...
                switch (
                    (t.element.data('timepicker-event-namespace', Math.random()),
                        e(i).bind('click.timepicker-' + t.element.data('timepicker-event-namespace'), function(e) {
                            t.element.get(0) === e.target ?
                                t.element.data('timepicker-user-clicked-outside', !1) :
                                t.element.data('timepicker-user-clicked-outside', !0).blur();
                        }),
                        (t.rebuild || !t.items || a) && (t.items = n._items(t, a ? r : null)),
                ...
                n.container.hasClass('ui-timepicker-no-scrollbar') ||
                    t.options.scrollbar ||
                    (n.container.addClass('ui-timepicker-no-scrollbar'), n.viewport.css({ paddingRight: 40 }));
                var o = n.container.outerHeight() - n.container.height(),
                    s = t.options.zindex ? t.options.zindex : t.element.offsetParent().css('z-index'),
                    c = t.element.offset();
                n.container.css({ top: c.top + t.element.outerHeight(), left: c.left }),
                    n.container.show(),
                    n.container.css({
            ...
            close: function(t) {
                ...
                return (
                    n.instance === t &&
                    (n.container.addClass('ui-helper-hidden ui-timepicker-hidden').hide(),
                        n.ui.scrollTop(0),
                        n.ui.children().removeClass('ui-state-hover')),
                    e(i).unbind('click.timepicker-' + t.element.data('timepicker-event-namespace')),
                    t.element
                );
            },
            closed: function() {
            ...
            setTime: function(t, i, r) {
                ...
                if (('string' == typeof i && (i = t.parse(i)), i && i.getMinutes && a._isValidTime(t, i))) {
                    if (((i = n(i)), (t.selectedTime = i), t.element.val(t.format(i, t.options.timeFormat)), r))
                        return t;
        ...
        (e.TimePicker.methods = { chainable: ['next', 'previous', 'open', 'close', 'destroy', 'setTime'] }),
        ...
        (e.fn.timepicker.parseTime = (function() {
            ...
            return function(r) {
                ...
                return (
                    ...
                    ((c = r.substr(0, 1)), (u = r.substr(1, 2)), (l = r.substr(3, 2))) :
                    (4 === r.length || r.length > 5) &&
                    ((c = r.substr(0, 2)), (u = r.substr(2, 2)), (l = r.substr(4, 2))),
                    ...
                    ((c = parseInt(c, 10)),
                        ...
                        e.fn.timepicker.parseTime(r + '0' + (o ? 'a' : '') + (s ? 'p' : '')) :
                        (a.setHours(c, u, l), a))
                );
            };
        })());
