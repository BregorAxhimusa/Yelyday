!(function(e, t) {
    ...
    function M(e) {
        w(this, e),
            ...
            this.isValid() || (this._d = new Date(NaN)), !1 === t && ((t = !0), c.updateOffset(this), (t = !1));
    }
            ...
            ('string' == typeof r && (e._i = r = e._locale.preparse(r)),
                ...
                (h(r) ?
                    ...
                    ((s = t),
                        ...
                        (vt(s), !1 === s._isValid &&
                            (delete s._isValid,
                                Dt(s), !1 === s._isValid && (delete s._isValid, c.createFromInputFallback(s)))) :
                        (s._d = new Date(+i[1]))) :
                    o(n) ?
        ...
        if (this._monthsParseExact)
            return function(e, t, n) {
                ...
                if (!this._monthsParse)
                    for (
                        this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = [], s = 0; s < 12;
                        ++s
                    )
                        (r = y([2e3, s])),
        ...
        if (this._weekdaysParseExact)
            return function(e, t, n) {
                ...
                if (!this._weekdaysParse)
                    for (
                        this._weekdaysParse = [], this._shortWeekdaysParse = [], this._minWeekdaysParse = [], s = 0; s < 7;
                        ++s
                    )
                        (r = y([2e3, 1]).day(s)),
    ...
    return (
        ...
        (c.updateLocale = function(e, t) {
            if (null != t) {
                ...
                null != st[e] &&
                (null != st[e].parentLocale ? (st[e] = st[e].parentLocale) : null != st[e] && delete st[e]);
            return st[e];
        }),
        (c.locales = function() {
            return s(st);
